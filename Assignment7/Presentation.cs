...
namespace Assignment7
{
    public static class Presentation 
    {
        ...
        public static void PrintStorageDetails(Storage storage)
        {
            Console.WriteLine("Total price = " + storage.TotalPrice + " | Total weight = " + storage.TotalWeight);
        ...
        public static void FillInStorageByHand(Storage storage)
        {
        ...
        public static void FillStorageFromFile(Storage storage, string filename)
        {
        ...
        public static void SaveStorageToFile(Storage storage, string filename)
        {
